[![Build Status](https://travis-ci.com/andrasak/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.com/andrasak/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/andrasak/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/andrasak/travis-ci-tutorial-java)
...
1. [Fork](https://github.com/andrasak/travis-ci-tutorial-java/fork) this Repository
